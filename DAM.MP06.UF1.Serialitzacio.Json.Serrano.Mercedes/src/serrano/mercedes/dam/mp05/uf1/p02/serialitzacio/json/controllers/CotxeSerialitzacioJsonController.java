package serrano.mercedes.dam.mp05.uf1.p02.serialitzacio.json.controllers;

import java.util.List;

import serrano.mercedes.dam.mp05.uf1.p02.serialitzacio.json.model.domain.Cotxe;
import serrano.mercedes.dam.mp05.uf1.p02.serialitzacio.json.model.service.CotxeSerialitzacioJsonService;
import serrano.mercedes.dam.mp05.uf1.p02.serialitzacio.json.view.FormulariCotxeView;
import serrano.mercedes.dam.mp05.uf1.p02.serialitzacio.json.view.UtilitatsSortidaView;

public class CotxeSerialitzacioJsonController {

	private CotxeSerialitzacioJsonController() {

	}

	public static CotxeSerialitzacioJsonController getInstance() {
		if (instance == null) {
			instance = new CotxeSerialitzacioJsonController();
		}
		return instance;
	}

	private static CotxeSerialitzacioJsonController instance = null;
